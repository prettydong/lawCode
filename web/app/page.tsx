    ...
    <div className="h-full overflow-auto px-6 pt-[6vh] fade-in relative">
      ...
      <div className="w-full max-w-xl mx-auto relative z-10">
        ...
        <div className="relative mb-6">
          <input
            className="w-full px-4 py-3 bg-[var(--color-surface)] border border-[var(--color-border)] text-[15px] text-[var(--color-text)] placeholder:text-[var(--color-text-muted)] outline-none transition-all focus:border-[var(--color-accent)] focus:shadow-[0_0_0_3px_rgba(232,89,12,0.08)]"
                  ...
                  >
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2">
                        ...
                        {!available && (
                          <span className="shrink-0 text-[11px] px-1.5 py-0.5 bg-[var(--color-bg-warm)] text-[var(--color-text-muted)]">即将上线</span>
                        )}
                      </div>
