...
\pairsectionleft{1. 是否主张工资报酬}{
是$\square$\hspace{1em}项目及金额：\hspace{4em}元，截至\hspace{4em}年\hspace{2em}月\hspace{2em}日止，欠利息\hspace{4em}元；\\
计算方式：\\
是否请求支付至实际清偿之日止：是$\square$\hspace{1em}否$\square$\\
否$\square$
}

\pairsectionleft{2. 是否主张遣返费}{
是$\square$\hspace{1em}费用\hspace{4em}元\\
否$\square$
}

\pairsectionleft{3. 是否主张社保费用}{
是$\square$\hspace{1em}费用\hspace{4em}元\\
否$\square$
}
...
\pairsectionleft{3. 合同履行情况}{
（包括船名、船舶所有人名称或姓名、雇主姓名、上船时间、下船时间、\\
工作内容、回港时间、地点、实际领取工资及报酬等）
}

\pairsectionleft{4. 仲裁相关情况}{
（申请仲裁时间、仲裁请求、仲裁文书、仲裁结果等）
}

\pairsectionleft{5. 其他情况}{
\mbox{}
}
