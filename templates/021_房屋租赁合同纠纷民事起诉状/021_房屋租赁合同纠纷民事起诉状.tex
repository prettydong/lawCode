...
\pairsection{1. 支付租金（元）}{
到期未付租金\hspace{4em}元（人民币，下同；如外币需特别注明）\\
明细：
}

\pairsection{2. 迟延支付租金的利息\\（违约金）}{
...
\pairsection{6. 支付房屋占有使用费}{
是$\square$\hspace{1em}内容：\\
否$\square$
}

\pairsection{7. 支付水电费等费用}{
是$\square$\hspace{1em}内容：\\
否$\square$
}
...
\pairsection{9. 是否主张实现债权的\\费用}{
是$\square$\hspace{1em}内容：\\
否$\square$
}

\pairsection{10. 是否主张诉讼费用}{
是$\square$\\
否$\square$
}
...
\pairsection{1. 合同的签订情况（名\\称、编号、签订时间、\\地点等）}{
\mbox{}
}
...
\pairsection{3. 租赁标的物情况（坐\\落位置、面积、产权\\情况等）}{
\mbox{}
}

\pairsection{4. 合同约定的租赁期限}{
自\hspace{2em}年\hspace{2em}月\hspace{2em}日起至\hspace{2em}年\hspace{2em}月\hspace{2em}日止
}

\pairsection{5. 合同约定的租金及支\\付方式}{
...
\pairsection{6. 其他费用约定（物业\\费、水电燃气费用等）}{
出租人负担：\\
承租人负担：
}
...
\pairsection{8. 是否约定合同解除的\\条件}{
是$\square$\hspace{1em}具体内容：\\
否$\square$
}

\pairsection{9. 租赁物交付时间}{
