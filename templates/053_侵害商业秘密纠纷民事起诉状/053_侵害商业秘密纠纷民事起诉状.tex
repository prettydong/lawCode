...
\pairsection{3. 原告主张的商业秘密\\符合法定条件}{
...
\pairsection{4. 被告侵犯商业秘密的\\事实（包括时间、地\\点、表现形式、具体\\内容、主观故意程度\\和损害后果等）}{
...
\pairsection{5. 侵犯商业秘密行为与\\原告损失之间的因果\\关系}{
具体情况，依据（证据）
}

\pairsection{6. 侵害技术秘密案件中\\的技术比对分析}{
具体主张密点或整体技术方案、比对分析意见（可另附页）
}

\pairsection{7. 其他情况及依据}{
\mbox{}
}

\pairsection{8. 证据清单（可另附\\页）}{
\mbox{}
}
