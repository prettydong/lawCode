...
\pairsection{1. 技术合同的签订情况\\（技术领域，项目的名\\称，标的的内容、范\\围和要求，履行的计\\划、地点和方式，技\\术成果的归属和收益\\的分配办法，验收标\\准和方法等）}{
\mbox{}
}

\pairsection{2. 合同签订主体}{
\mbox{}
}

\pairsection{3. 约定的合同期限}{
\hspace{8em}年\hspace{2em}月\hspace{2em}日起至\hspace{8em}年\hspace{2em}月\hspace{2em}日止
}

\pairsection{4. 约定的给付价款、\\报酬、使用费及支付\\方式}{
\mbox{}
}

\pairsection{5. 约定的给付价款利息\\（违约金）及计算方式}{
\mbox{}
}

\pairsection{6. 技术合同履行情况}{
\mbox{}
}
