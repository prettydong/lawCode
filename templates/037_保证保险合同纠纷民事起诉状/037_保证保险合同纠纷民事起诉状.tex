...
\pairsection{1. 保证保险合同的签\\订情况（合同名称、主\\体、签订时间、地点等）}{
\mbox{}
}
...
\pairsection{3. 是否对被告就保证保\\险合同主要条款进行\\提示注意、说明}{
是$\square$\hspace{1em}提示说明的具体方式以及时间地点：\\
否$\square$
}

\pairsection{4. 被告借款合同的主\\要约定（借款金额、期\\限、用途、利息标准、\\还款方式、担保、违\\约责任、解除条件、\\管辖约定）}{
\mbox{}
}

\pairsection{5. 被告逾期未还款情况}{
...
\pairsection{8. 请求承担责任的依据}{
合同约定：\\
法律规定：
}

\pairsection{9. 其他需要说明的内\\容（可另附页）}{
\mbox{}
}

\pairsection{10. 证据清单（可另附\\页）}{
\mbox{}
}
