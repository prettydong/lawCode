...
\pairsection{2. 利息、罚息、复利、\\滞纳金、违约金、手\\续费等}{
...
\pairsection{3. 是否主张担保权利}{
是$\square$\hspace{1em}内容：\\
否$\square$
}

\pairsection{4. 是否主张实现债权的\\费用}{
是$\square$\hspace{1em}费用明细：\\
否$\square$
}

\pairsection{5. 是否主张诉讼费用}{
是$\square$\\
否$\square$
}
...
\pairsection{1. 信用卡办理情况\\（信用卡卡号、信用\\卡登记权利人、办卡\\时间、办卡行等）}{
\mbox{}
}

\pairsection{2. 信用卡合约的主要\\约定}{
透支金额：\\
...
\pairsection{3. 是否就信用卡合约主\\要条款进行提示注意}{
是$\square$\hspace{1em}提示说明的具体方式以及时间地点：\\
否$\square$
}

\pairsection{4. 被告逾期部分已还\\金额}{
\hspace{2em}元
}

\pairsection{5. 被告逾期未还款金额}{
逾期时间：\\
...
\pairsection{6. 是否向被告进行通知\\和催收}{
是$\square$\hspace{1em}具体情况：\\
否$\square$
}

\pairsection{7. 是否签订物的担保\\（抵押、质押）合同}{
是$\square$\hspace{1em}签订时间：\\
否$\square$
}

\pairsection{8. 担保人、担保物}{
担保人：\\
担保物：
}

\pairsection{9. 是否最高额担保\\（抵押、质押）}{
是$\square$\\
否$\square$\\
担保债权的确定时间：\\
担保额度：
...
\pairsection{13. 其他担保方式}{
是$\square$\hspace{1em}形式：\hspace{6em}签订时间：\\
否$\square$
}

\pairsection{14. 请求承担责任的\\依据}{
合同约定：\\
法律规定：
}

\pairsection{15. 其他需要说明的\\内容（可另附页）}{
\mbox{}
}

\pairsection{16. 证据清单（可另附\\页）}{
\mbox{}
}
