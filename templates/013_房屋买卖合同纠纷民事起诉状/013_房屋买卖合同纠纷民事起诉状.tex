...
\pairsection{7. 解除担保贷款（按揭）\\合同}{
无此问题$\square$\\
有此问题$\square$\hspace{4em}具体要求：
}

\pairsection{8. 鉴定及其他实现债权\\的费用}{
无此问题$\square$\\
有此问题$\square$\\
...
\pairsection{1. 涉及房屋买卖合同\\关系的基本情况}{
合同订立时间：\\
...
\pairsection{5. 中介服务费情况}{
应返还$\square$ / 承担$\square$\hspace{2em}中介服务费的事由
}

\pairsection{6. 质量损害赔偿相关\\情况}{
...
\pairsection{7. 是否签订担保贷款\\（按揭）合同}{
是$\square$\hspace{1em}具体情况：\\
否$\square$
}

\pairsection{8. 申请鉴定及其他实\\现债权费用的事实}{
是$\square$\hspace{1em}具体情况：\\
否$\square$
}
