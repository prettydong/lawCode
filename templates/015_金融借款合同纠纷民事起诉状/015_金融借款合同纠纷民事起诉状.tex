...
\pairsection{3. 是否要求提前还款或\\解除合同}{
是$\square$\hspace{1em}提前还款（加速到期）$\square$ / 解除合同$\square$\\
否$\square$
}

\pairsection{4. 是否主张担保权利}{
是$\square$\hspace{1em}内容：\\
否$\square$
}

\pairsection{5. 是否主张实现债权的\\费用}{
...
\pairsection{1. 合同签订情况（名\\称、编号、签订时间、\\地点等）}{
\mbox{}
}
...
\pairsection{9. 是否存在逾期还款}{
是$\square$\hspace{1em}逾期时间：\hspace{6em}至今已逾期\\
否$\square$
}

\pairsection{10. 是否签订物的担保\\（抵押、质押）合同}{
是$\square$\hspace{1em}签订时间：\\
否$\square$
}

\pairsection{11. 担保人、担保物}{
担保人：\\
担保物：
}
...
\pairsection{16. 其他担保方式}{
是$\square$\hspace{1em}形式：\hspace{6em}签订时间：\\
否$\square$
}

\pairsection{17. 请求承担责任的\\依据}{
合同约定：\\
法律规定：
}

\pairsection{18. 其他需要说明的内\\容（可另附页）}{
\mbox{}
}

\pairsection{19. 证据清单（可另附\\页）}{
\mbox{}
}
