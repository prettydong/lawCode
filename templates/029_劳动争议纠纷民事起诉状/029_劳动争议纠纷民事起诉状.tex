...
\pairsection{1. 是否主张工资支付}{
是$\square$\hspace{1em}否$\square$\\
明细：
}

\pairsection{2. 是否主张未签订书面\\劳动合同双倍工资}{
是$\square$\hspace{1em}否$\square$\\
明细：
}

\pairsection{3. 是否主张加班费}{
是$\square$\hspace{1em}否$\square$\\
明细：
}

\pairsection{4. 是否主张未休年休假\\工资}{
是$\square$\hspace{1em}否$\square$\\
明细：
}

\pairsection{5. 是否主张未依法缴纳\\社会保险费造成的经\\济损失}{
是$\square$\hspace{1em}否$\square$\\
明细：
}

\pairsection{6. 是否主张解除劳动合\\同经济补偿}{
是$\square$\hspace{1em}否$\square$\\
明细：
}

\pairsection{7. 是否主张违法解除劳\\动合同赔偿金}{
是$\square$\hspace{1em}否$\square$\\
明细：
}
...
\pairsection{1. 劳动合同签订情况}{
（合同主体、签订时间、地点、合同名称等）
}

\pairsection{2. 劳动合同履行情况}{
...
\pairsection{5. 劳动仲裁相关情况}{
（申请劳动仲裁时间、仲裁请求、仲裁文书、仲裁结果等）
}

\pairsection{6. 其他相关情况}{
（如是否是农民工）
}
