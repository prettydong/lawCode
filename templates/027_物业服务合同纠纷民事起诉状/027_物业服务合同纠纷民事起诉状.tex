...
\pairsection{1. 物业服务合同或前期\\物业服务合同签订情\\况（名称、编号、签\\订时间、地点等）}{
\mbox{}
}
...
\pairsection{3. 物业项目情况}{
坐落位置：\\
面积：\hspace{4em}所有权人：
}

\pairsection{4. 约定的物业费标准}{
\mbox{}
}

\pairsection{5. 约定的物业服务期限}{
\hspace{2em}年\hspace{2em}月\hspace{2em}日起至\hspace{2em}年\hspace{2em}月\hspace{2em}日止
}

\pairsection{6. 约定的物业费支付\\方式}{
\mbox{}
}

\pairsection{7. 约定的逾期支付物业\\费违约金标准}{
\mbox{}
}
...
\pairsection{8. 被告欠付物业费数额\\及计算方式}{
欠付物业费数额：\\
具体计算方式：
}

\pairsection{9. 被告应付违约金数额\\及计算方式}{
应付违约金数额：\\
具体计算方式：
}
