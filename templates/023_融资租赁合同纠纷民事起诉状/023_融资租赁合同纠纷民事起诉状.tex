...
\pairsection{3. 是否确认租赁物归原\\告所有}{
是$\square$\\
否$\square$
}

\pairsection{4. 请求解除合同}{
判令解除融资租赁合同$\square$\\
确认融资租赁合同已于\hspace{2em}年\hspace{2em}月\hspace{2em}日解除$\square$
}

\pairsection{5. 返还租赁物，并赔偿\\因解除合同而受到的\\损失}{
...
\pairsection{1. 合同的签订情况\\（名称、编号、签订\\时间、地点）}{
\mbox{}
}
...
\pairsection{3. 租赁物情况（租赁物\\的选择、名称、规格、\\质量、数量等）}{
\mbox{}
}

\pairsection{4. 合同约定的租金及支\\付方式}{
租金\hspace{4em}元；\\
...
\pairsection{6. 到期后租赁物归属}{
归承租人所有$\square$\\
归出租人所有$\square$\\
留购价款\hspace{4em}元
}

\pairsection{7. 合同约定的违约责任}{
\mbox{}
}

\pairsection{8. 是否约定加速到期\\条款}{
是$\square$\hspace{1em}具体内容：\\
否$\square$
}

\pairsection{9. 是否约定回收租赁物\\条件}{
是$\square$\hspace{1em}具体内容：\\
否$\square$
}

\pairsection{10. 是否约定解除合同\\条件}{
是$\square$\hspace{1em}具体内容：\\
否$\square$
}

\pairsection{11. 租赁物交付时间}{
于\hspace{2em}年\hspace{2em}月\hspace{2em}日交付租赁物
}

\pairsection{12. 租赁物情况}{
...
\pairsection{15. 是否签订物的担保\\（抵押、质押）合同}{
是$\square$\hspace{1em}签订时间：\\
否$\square$
}

\pairsection{16. 担保人、担保物}{
担保人：\\
担保物：
}

\pairsection{17. 是否最高额担保\\（抵押、质押）}{
是$\square$\hspace{1em}担保债权的确定时间：\\
\hspace*{21bp}担保额度：\\
否$\square$
}

\pairsection{18. 是否办理抵押、质\\押登记}{
是$\square$\hspace{1em}正式登记$\square$\\
\hspace*{21bp}预告登记$\square$\\
否$\square$
}

\pairsection{19. 是否签订保证合同}{
...
\pairsection{21. 其他担保方式}{
是$\square$\hspace{1em}形式：\hspace{4em}签订时间：\\
否$\square$
}

\pairsection{22. 请求承担责任的\\依据}{
合同约定：\\
法律规定：
}

\pairsection{23. 其他需要说明的\\内容（可另附页）}{
\mbox{}
}

\pairsection{24. 证据清单（可另附\\页）}{
\mbox{}
}
