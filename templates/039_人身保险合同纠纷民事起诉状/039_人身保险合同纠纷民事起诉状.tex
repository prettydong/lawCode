...
\pairsection{1. 人身保险合同的签\\订情况（合同名称、主\\体、签订时间、地点、\\保险合同订立时投保人\\与被保险人的关系等）}{
\mbox{}
}

\pairsection{2. 人身保险合同的主\\要约定}{
承保险种：\\
投保人：\\
...
\pairsection{3. 是否依法就人身保险\\合同中与投保人有重\\大利害关系的条款进\\行提示、说明}{
是$\square$\\
否$\square$\hspace{1em}事实与理由：
}

\pairsection{4. 保险事故发生的情况\\（事故发生时间及经过\\等；意外事故导致受伤\\或死亡的，写明出警情\\况、公安机关对于意外\\死亡的证明情况）}{
\mbox{}
}
