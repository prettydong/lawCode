...
\newcommand{\breakablepairsection}[2]{%
    \begin{tcolorbox}[
        breakable,
        width=467.72bp, sharp corners, colback=white, colframe=inkblack, boxrule=0.5pt,
        enlarge left by=-19.28bp,
        before={\nointerlineskip\vspace{-0.5pt}\noindent}, after=\par,
        boxsep=0pt, left=117.4bp, right=4bp, top=4bp, bottom=4bp,
        overlay unbroken={%
            \draw[line width=0.5pt] ([xshift=112.9bp]frame.north west) -- ([xshift=112.9bp]frame.south west);
            \node[align=center, text width=112.9bp, inner sep=0pt] at ([xshift=56.45bp]frame.center) {{\songti\fontsize{10.5bp}{10.5bp}\selectfont #1}};
        },
        overlay first={%
            \draw[line width=0.5pt] ([xshift=112.9bp]frame.north west) -- ([xshift=112.9bp]frame.south west);
            \node[align=center, text width=112.9bp, inner sep=0pt] at ([xshift=56.45bp]frame.center) {{\songti\fontsize{10.5bp}{10.5bp}\selectfont #1}};
...
\begin{notesection}
\hfuzz=50pt
\color{inkblack}\heiti\fontsize{10.5bp}{15bp}\selectfont 说明：\par
\vspace*{-0.2bp}
\songti\mdseries\fontsize{10.5bp}{15bp}\selectfont
...
\breakablepairsection{原告\\（法人、非法人组织）}{
名称：\\
住所地（主要办事机构所在地）：\\
注册地 / 登记地：\\
...
\breakablepairsection{被告\\（法人、非法人组织）}{
名称：\\
住所地（主要办事机构所在地）：\\
注册地 / 登记地：\\
法定代表人 / 负责人：\hspace{4em}职务：\hspace{4em}联系电话：\\
...
\breakablepairsection{第三人\\（法人、非法人组织）}{
名称：\\
住所地（主要办事机构所在地）：\\
注册地 / 登记地：\\
法定代表人 / 负责人：\hspace{4em}职务：\hspace{4em}联系电话：\\
